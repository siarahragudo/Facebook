...
$Password = $_POST['password'];
          $sqlSelect="SELECT * FROM tblFacebook WHERE mobileoremail='$Email' AND npassword='$Password'";
          $query=mysqli_query($connect,$sqlSelect);
          $rows=mysqli_fetch_assoc($query);  
               if($rows['mobileoremail']==$Email && $rows['npassword']==$Password){
	...
	<div class="create-account">
		...
		<div class="account">
			...
			<div class="mobileoremail">
				<input type="text" name="mobileoremail" placeholder="  Mobilenumberoremail"><br>
			</div>
...
if(isset($_POST['register'])){
     ...
     if(isset($_POST['gender'])){
          ...
          $Year = $_POST['year'];
          $Gender = $_POST['gender'];
          $sqlInsert = "INSERT INTO tblfacebook(fname,lname,mobileoremail,npassword,month,day,year,gender)VALUES('$Firstname','$Lastname','$Mobileoremail','$Newpassword','$Month',$Day,Year,'$Gender')";
